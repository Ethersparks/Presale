...
class AwsService {
  ...
  executeQuery(queryString, values, successCallback) {
    if (!values) {
      values = [];
    }
  ...
  //         IS_DELETED CHAR(1), CREATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP,UPDATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,PRIMARY KEY (PRESALE_ID))	
  //   `;
  //   const values = "";
